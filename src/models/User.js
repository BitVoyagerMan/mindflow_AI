...
const UserSchema = new User({
  ...
  voiceEnable: { type: Boolean, default: true },
  voiceType: { type: Boolean, default: true },
  processTips: { type: Boolean, default: true },
  role: { type: Number, default: 0 }, // 0: user, 1: tester, 2: admin
  tokens: [
    {
...
UserSchema.set("toJSON", {
  ...
  transform: function (doc, ret, options) {
    const { firstName, lastName, email, voiceEnable, voiceType, processTips, role } = ret;

    return { firstName, lastName, email, voiceEnable, voiceType, processTips, role }; // return fields we need
  },
});
